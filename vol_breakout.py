...
if __name__ == "__main__":
    ...
    eth_vol_results = run_volatility_breakout_backtest(
        symbol='ethusd',
        timeframe='10m',
        bb_window=20,
        bb_std=2,
    ...
    # Display charts
    eth_vol_results['price_chart'].show()
    eth_vol_results['equity_chart'].show()
    eth_vol_results['order_chart'].show()
    eth_vol_results['trade_returns_chart'].show()
    eth_vol_results['cumulative_returns_chart'].show()
